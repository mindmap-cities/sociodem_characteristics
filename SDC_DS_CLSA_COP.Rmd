...
opal.assign.table.tibble(erasmus_opal, 'CoP_FU1','CLSA_1.CoP_FU1',  variables=list("AGE_NMBR_COF1", "SDC_BTHSEX_COF1", "RET_RTRD_COF1" , "LBF_CURR_COF1", "RET_RTRD_COF1", "LBF_EVER_COF1", "RET_RTRD_COF1","RET_AGE_NB_COF1", "SDC_MRTL_COF1","SN_LIVH_M1_R_COF1",  "SN_LIVH_M2_R_COF1", "SN_LIVH_M3_R_COF1", "SN_LIVH_M4_R_COF1", "SN_LIVH_M5_R_COF1", "SN_LIVH_M6_R_COF1", "SN_LIVH_M7_R_COF1", "SN_LIVH_M8_R_COF1", "SN_LIVH_M9_R_COF1", "SN_LIVH_M10_R_COF1", "SN_LIVH_NB_COF1","SDC_MRTL_COF1", "RET_RTRN_COF1", "RET_RTRN_COF1", "ED_OTED_COF1" , "SN_CHILD_NB_COF1", "LBF_EVER_COF1"))
...
table(sdc_CLSA_cop0$sdc_employ_0)
```  
### **Variable label**: Employment status   
...
sdc_CLSA_cop0$sdc_retire_0<- ifelse(CLSA_cop0$RET_RTRD_COM==1|CLSA_cop0$RET_RTRD_COM==2, 1L, ifelse(CLSA_cop0$RET_RTRD_COM==3|CLSA_cop0$LBF_EVER_COM==2,0L,  NA))
...
table(CLSA_cop1$RET_RTRN_COF1, useNA = "always")
...
sdc_CLSA_cop0$sdc_highest_edu_0<-ifelse(CLSA_cop0$ED_UDR11_COM==1|CLSA_cop0$ED_UDR11_COM==2, 1L,
                                 ...
                                 ifelse(CLSA_cop0$ED_UDR11_COM==6|CLSA_cop0$ED_UDR11_COM==7| CLSA_cop0$ED_UDR11_COM==8|CLSA_cop0$ED_UDR11_COM==11, 3L,
...
# 3 | Post-secondary non-tertiary education or short-cycle tertiary education (ISCED 4,5)
# 4 | Bachelor,master,doctoral,or equivalent (ISCED 6,7,8)
sdc_CLSA_cop0$sdc_postsec_edu_0<-ifelse(sdc_CLSA_cop0$sdc_highest_edu_0==3|sdc_CLSA_cop0$sdc_highest_edu_0==4,1L, ifelse(is.na(sdc_CLSA_cop0$sdc_highest_edu_0), NA,0L))
...
table(sdc_CLSA_cop0$sdc_livstat_0)
...
**R script**:  
```{r, echo=TRUE}
sdc_CLSA_cop1$sdc_livstat_1<- recode(CLSA_cop1$SDC_MRTL_COF1,'1'=0L, '2'=1L, '3'=0L,'4'=0L,'5'=0L,.default=NA_integer_)
table(sdc_CLSA_cop1$sdc_livstat_1)
```   
### **Variable label**: Married or living with partner  
...
sdc_CLSA_cop1$sdc_num_childhh_1<- rowSums(CLSA_cop1[,22:29], na.rm=TRUE)
