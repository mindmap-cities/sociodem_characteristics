...
sdc_CLSA_cop0$sdc_employ_0<- ifelse((CLSA_cop0$LBF_CURR_COM=='1'|CLSA_cop0$LBF_STTS_COM=='1'|CLSA_cop0$LBF_STTS_COM=='2'|CLSA_cop0$LBF_STTS_COM=='3')&(CLSA_cop0$LBF_EVER_COM!="2"|is.na(CLSA_cop0$LBF_EVER_COM))&(CLSA_cop0$RET_RTRD_COM=="3"|CLSA_cop0$RET_RTRD_COM=="2"),1L,  
                                 ifelse(CLSA_cop0$LBF_CURR_COM=='2'|CLSA_cop0$RET_RTRD_COM=="1"|CLSA_cop0$LBF_EVER_COM=="2", 0L, NA))

table(sdc_CLSA_cop0$sdc_employ_0,useNA="always")

table(CLSA_cop0$LBF_CURR_COM, CLSA_cop0$LBF_STTS_COM, useNA = "always")
...
table(sdc_CLSA_cop0$sdc_employ_0,CLSA_cop0$LBF_EVER_COM, useNA="always")
table(CLSA_cop0$LBF_EVER_COM, useNA="always")

table(CLSA_cop0$RET_RTRD_COM,CLSA_cop0$LBF_STTS_COM, useNA="always")
table(CLSA_cop0$RET_RTRD_COM,a, useNA="always")
...
table(CLSA_cop1$LBF_CURR_COF1, CLSA_cop1$LBF_STTS_COF1, useNA = "always")
...
sdc_CLSA_cop1$sdc_num_childhh_1<- rowSums(CLSA_cop1[,25:33], na.rm=TRUE)
