...
#HAPIEE_W2 
opal.assign.table.tibble(erasmus_opal, 'HAPIEE_W2', 'HAPIEE.HAPIEE_W2',variables = list('country','numhouse','child','w2date','age_lt','q2_lt','q3_lt','q4_lt','w2chldno_lt','w2child_lt','paidwork','retired'))
HAPIEE_W2<- opal.execute(erasmus_opal,'HAPIEE_W2')

# opal.assign.table.tibble(erasmus_opal, 'HAPIEE_W2_all', 'HAPIEE.HAPIEE_W2',variables = NULL)
# HAPIEE_W2_all<- opal.execute(erasmus_opal,'HAPIEE_W2_all')
