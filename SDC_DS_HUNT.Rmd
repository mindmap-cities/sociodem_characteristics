...
# HUNT2
opal.assign.table.tibble(erasmus_opal, 'HUNT2', 'HUNT.HUNT2', variables=list('PartAg_NT2BLQ1','Educ_NT2BLQ1','MaritStat_NT2BLQ1','MaritStat_NT2BLQ2','WorRetir_NT2BLQ1','WorNot_NT2BLQ2','CohNo_NT2BLQ2','CohSps_NT2BLQ2','WorPaid_NT2BLQ1','WorUnemp_NT2BLQ1','WorEducMil_NT2BLQ1','WorHome_NT2BLQ1','WorTrad_NT2BLQ1','CohAdN_NT2BLQ2','CohChiN_NT2BLQ2','DelivN_NT2BLQ2')) 
HUNT2<- opal.execute(erasmus_opal,'HUNT2')

# HUNT3
opal.assign.table.tibble(erasmus_opal, 'HUNT3', 'HUNT.HUNT3',variables=list('PartAg_NT3BLQ1','MaritStat_NT3BLQ1','WorCu_NT3BLI','CohSps_NT3BLQ2','CohNo_NT3BLQ2')) 
...
**Harmonization status**:  complete  
**Harmonization comment**:  New participants recruited through follow-up phases.See baseline.Take gender from baseline.     
**R script**:  
```{r, echo=TRUE}
...
**R script**:  
```{r, echo=TRUE}
sdc_HUNT_0$sdc_highest_edu_0<- recode(as.integer(HUNT1$Educ_NT1BLQ2), '1'=1L,'2'=1L,'3'=1L,'4'=1L,'5'=3L,'6'=4L,'7'=4L,'8'=4L)
...
sdc_HUNT_1$sdc_livstat_1<- recode(as.integer(HUNT2$MaritStat_NT2BLQ2),
                            '1'=0L,'2'=1L,'3'=0L,'4'=0L,'5'=0L,'6'=1L,'7'=0L,'8'=0L,'9'=0L) 
```   
### **Variable label**: Married or living with partner  
