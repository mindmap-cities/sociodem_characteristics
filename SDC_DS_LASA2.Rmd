...
# LASA2B
opal.assign.table.tibble(erasmus_opal, 'LASA2B', 'LASA.LASA2B',variables = list('bage',"sex","bmarst","aeducat","bpartst","bpartner","bretired","bjob1",'binccat'))
LASA2B <- opal.execute(erasmus_opal,'LASA2B')

# LASA2F
opal.assign.table.tibble(erasmus_opal, 'LASA2F', 'LASA.LASA2F', variables=list('fage','sex','fmarst','aeducat','fpartner','fjob1','finccat','fretired')) 
LASA2F<- opal.execute(erasmus_opal,'LASA2F')

# LASA2G
opal.assign.table.tibble(erasmus_opal,'LASA2G','LASA.LASA1G',variables=list('gage','sex','gmarst','aeducat','gpartner',
                                                                             'gjob1','gretired','ginccat')) 
LASA2G <- opal.execute(erasmus_opal,'LASA2G')

# LASA2H
opal.assign.table.tibble(erasmus_opal, 'LASA2H', 'LASA.LASA2H',variables=list('hage','sex','hmarst','aeducat','hpartner',
                                                                              'hjob1','hretired','hinccat')) 
...
**Harmonization status**:  complete  
**Harmonization comment**:   Waiting for cohort answer concerning bretired variable.    
**R script**:  
```{r, echo=TRUE}
sdc_LASA2_0$sdc_retired_0 <- recode(as.integer(LASA2B$bretired),'0'=0L,'1'=1L,'2'=1L, .default= NA_integer_)
...
**Harmonization status**:  complete  
**Harmonization comment**:   Waiting for cohort answer concerning fretired variable. 
**R script**:  
```{r, echo=TRUE}
sdc_LASA2_1$sdc_retired_1 <- recode(as.integer(LASA2F$fretired),'0'=0L,'1'=1L,'2'=1L, .default= NA_integer_)
...
**R script**:  
```{r, echo=TRUE}
sdc_LASA2_2$sdc_retired_2 <- recode(as.integer(LASA2G$gretired),'0'=0L,'1'=1L,'2'=1L, .default= NA_integer_)
...
**R script**:  
```{r, echo=TRUE}
sdc_LASA2_3$sdc_retired_3 <- recode(as.integer(LASA2H$hretired),'0'=0L,'1'=1L,'2'=1L, .default= NA_integer_)
