...
**R script**:  
```{r, echo=TRUE}
sdc_LUCAS_0$sdc_age_0<- floor((lucas_w2$DEingFBL_07 - lucas_w2$GebDat_07)/365)
```  
### **Variable label**: Age of participant   
...
**R script**:  
```{r, echo=TRUE}
sdc_LUCAS_0$sdc_gender_0<- ifelse(lucas_w2$SexCd_07 == 2, 0, 1)
...
**Harmonization status**:  impossible
**Harmonization comment**:   incompatible (Lucas47_07: i live alone or i live with someone else)   
**R script**:  
```{r, echo=TRUE}
