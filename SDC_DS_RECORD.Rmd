...
opal.assign.table.tibble(erasmus_opal, 'RECORD_w1_1', 'RECORD.RECORD_w1_1', variables = list('code_barre','Age','sexe','Adm14' ))
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_age_0<- RECORD_w1_1$Age
```  
### **Variable label**: Age of participant   
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_1$sdc_age_1<- RECORD_w2$age
```  
### **Variable label**: Age of participant   
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_gender_0<- ifelse(RECORD_w1_1$sexe =="F",1, ifelse(RECORD_w1_1$sexe =="H",0,NA))
```  
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_employ_0<- ifelse(RECORD_w1_2$activite_cgi=="act",1, ifelse(RECORD_w1_2$activite_cgi=="cho",0,NA))
```  
### **Variable label**: Employment status   
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_retire_0<- ifelse(RECORD_w1_2$activite_cgi=="ret",1, ifelse(RECORD_w1_2$activite_cgi=="act" | RECORD_w1_2$activite_cgi =="cho" | RECORD_w1_2$activite_cgi=="div", 0,NA))
```  
### **Variable label**: Retirement status   
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_1$sdc_retire_1<- RECORD_w2$P56_Q1_1208
```  
### **Variable label**: Retirement status   
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_income_0<- ifelse(RECORD_w1_2$q50_rvnu <"3500",0,1)
```  
### **Variable label**: Net annual household income    
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_1$sdc_income_1<- ifelse(RECORD_w2$P57_Q1_1219 == 1 | RECORD_w2$P57_Q1_1220 ==1 | RECORD_w2$P57_Q1_1221 ==1 | RECORD_w2$P57_Q1_1222 ==1, 0, ifelse(RECORD_w2$P57_Q1_1223 == 1 | RECORD_w2$P57_Q1_1224 ==1 | RECORD_w2$P57_Q1_1225 ==1 | RECORD_w2$P57_Q1_1226 ==1 |RECORD_w2$P57_Q1_1227 ==1 | RECORD_w2$P57_Q1_1228 ==1, 1, NA))
```    
### **Variable label**: Net annual household income    
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_livstat_0<- RECORD_w1_2$cohab_coup
```  
### **Variable label**: Married or living with partner  
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_1$sdc_livstat_1<- RECORD_w2$P54_Q1_1165
...
**R script**:  
```{r, echo=TRUE}
RECORD_w1_2$q48_nbadulte<- as.numeric(RECORD_w1_2$q48_nbadulte)
RECORD_w1_2$q49_nbenfant<- as.numeric(RECORD_w1_2$q49_nbenfant)
sdc_RECORD_0$sdc_num_pplhh_0<- rowSums(RECORD_w1_2[,c("q48_nbadulte","q49_nbenfant")])
```  
### **Variable label**: Number people in household  
...
**R script**:  
```{r, echo=TRUE}
RECORD_w2$P58_Q2_1237<- as.numeric(RECORD_w2$P58_Q2_1237)
RECORD_w2$P58_Q1_1234<- as.numeric(RECORD_w2$P58_Q1_1234)
sdc_RECORD_1$sdc_num_pplhh_1<- rowSums(RECORD_w2[,c("P58_Q2_1237","P58_Q1_1234")])
```  
### **Variable label**: Number people in household  
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_num_childhh_0<- RECORD_w1_2$q49_nbenfant
```  
### **Variable label**: Number children in household  
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_1$sdc_num_childhh_1<- RECORD_w2$P58_Q2_1237
```  
...
```   
### **Variable label**: Number of children   
**Variable name**: sdc_num_child_dich_4  
**Variable description**: Number of children (biological or adopted) of the participant.    
**Value type**: integer      
**Variable unit**: children  
**Category coding**: N/A  
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_1$sdc_child_1<- as.numeric(RECORD_w2$Qm137)
```  
