...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_employ_0<- as.integer(ifelse(RECORD_w1_2$activite_cgi=="act",1, ifelse(RECORD_w1_2$activite_cgi=="cho" | RECORD_w1_2$activite_cgi=="ret"|RECORD_w1_2$activite_cgi=="div",0,NA)))
```  
### **Variable label**: Employment status   
...
**Harmonization status**:  impossible  
**Harmonization comment**:   Many variables about employment but cannot be put together and harmonized.  
**R script**:  
```{r, echo=TRUE}
...
#all decimal in NA, all other char in NA, the rest in integer

sdc_RECORD_0$sdc_num_child_0 <- 
  RECORD_w1_1 %>%
    select (Qm3) %>%
    mutate(
      Qm3 = ifelse(Qm3 == "+" | Qm3 == "NA" | Qm3 == "fff" | Qm3 == "+++" | Qm3 == "Â²",NA,Qm3),
      Qm3 = ifelse(as.numeric(Qm3) == as.integer(Qm3), Qm3, NA),
      Qm3 = as.integer(Qm3)) %>% .[[1]]
...
RECORD_w1_1$Qm3 %>% unique

sdc_RECORD_0$sdc_child_0 <- 
as.integer(RECORD_w1_1 %>%
    select (Qm3) %>%
    mutate(
      Qm3 = ifelse(Qm3 == "+" | Qm3 == "NA" | Qm3 == "fff" | Qm3 == "+++" | Qm3 == "Â²",NA,Qm3),
      Qm3 = ifelse(as.numeric(Qm3) == as.integer(Qm3), Qm3, NA),
      # Qm3 = as.integer(Qm3),
      Qm3 = ifelse(Qm3>0,1,0)) %>% .[[1]])
