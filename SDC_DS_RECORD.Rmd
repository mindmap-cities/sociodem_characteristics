...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_employ_0<- as.integer(ifelse(RECORD_w1_2$activite_cgi=="act",1, ifelse(RECORD_w1_2$activite_cgi=="cho",0,NA)))
```  
### **Variable label**: Employment status   
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_0$sdc_postsec_edu_0<- recode(as.integer(RECORD_w1_1$Adm14),'1'=1L, '2'=1L,'3'=1L,
                                        '4'=1L,'5'=2L,'6'=2L, .default = NA_integer_)
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_1$sdc_postsec_edu_1<- recode(as.integer(RECORD_w2$Adm14),'1'=1L, '2'=1L,'3'=1L,
                                        '4'=1L,'5'=2L,'6'=2L, .default=NA_integer_)
```  
### **Variable label**: Post-secondary education    
...
**R script**:  
```{r, echo=TRUE}
sdc_RECORD_1$sdc_child_1<- as.integer(RECORD_w2$Qm137)
```  
